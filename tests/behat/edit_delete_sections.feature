...
Feature: Sections can be edited and deleted in topics2 format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete topics2
  ...
  Scenario: Deleting the middle section in topics2 format
