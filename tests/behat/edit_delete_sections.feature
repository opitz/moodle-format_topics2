@format @format_tabbedtopics
Feature: Sections can be edited and deleted in tabbedtopics format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete tabbedtopics
  ...
  @javascript
  Scenario: Inline edit section name in tabbedtopics format
  ...
  Scenario: Deleting the last section in tabbedtopics format
  ...
  Scenario: Deleting the middle section in tabbedtopics format
